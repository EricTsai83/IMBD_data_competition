...
grid_search_Ada = GridSearchCV(
    AdaBoostRegressor(),
    param_grid = {
        'n_estimators': np.array([100, 300, 500]),
...
# 模型超參數
Lasso_params = {
    'sensor_point5_i_value': {'alpha': 500}, 
...
Ridge_params = {
    'sensor_point5_i_value': {'alpha': 0.1}, 
...
XGB_params = {
    'sensor_point5_i_value': {'learning_rate': 0.2, 'max_depth': 3, 'min_child_weight': 10, 'n_estimators': 30, 'random_state': 1}, 
